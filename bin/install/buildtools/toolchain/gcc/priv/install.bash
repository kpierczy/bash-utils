...
source $BASH_UTILS_HOME/bin/install/buildtools/toolchain/gcc/priv/components/gcc_base.bash
source $BASH_UTILS_HOME/bin/install/buildtools/toolchain/gcc/priv/components/libc.bash
source $BASH_UTILS_HOME/bin/install/buildtools/toolchain/gcc/priv/components/libc_aux.bash
source $BASH_UTILS_HOME/bin/install/buildtools/toolchain/gcc/priv/components/gcc_final.bash
source $BASH_UTILS_HOME/bin/install/buildtools/toolchain/gcc/priv/components/gcc_final_aux.bash
