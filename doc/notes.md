...
4. [Bash wiki](https://wiki.bash-hackers.org/start)
5. [Bash regex](https://linuxconfig.org/advanced-bash-regex-with-examples)
6. [Linux From Scratch - installing basic system software](https://www.linuxfromscratch.org/lfs/view/stable/chapter08/chapter08.html)
